...
static NSString * const CLIENT_ID = @"000000004C061136";
 // PROD: @"000000004C061136";
 // INT:  @"00000000603DCD5F";
...
- (void) configureLiveClientWithScopes:(NSString *)scopeText
{
    ...
    //[LiveAuthHelper overrideLoginServer:@"login.live-int.com" authServer:@"login.live-int.com" apiServer:@"apis.live-int.net"]; 
